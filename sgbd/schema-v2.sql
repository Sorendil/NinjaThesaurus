...
(LIBELLE VARCHAR2(35),
VEDETTE_SRC VARCHAR2(1),
VEDETTE_DST VARCHAR2(1))
/
...
BEGIN
  ...
  if src_vedette != rel_type_src or dst_vedette != rel_type_dst then
    raise_application_error(-20001,'L\'association de ces descripteurs avec ce type de relation est impossible');
  end if;
END;
/
...
CREATE TABLE TYPES_RELATIONS OR TYPE_RELATION_T
(PRIMARY KEY (LIBELLE))
/
