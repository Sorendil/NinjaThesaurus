...
Pour le moment, notre table\_relations ne comportent que trois libelles : Synonyme, Généralisation et Spécialisation du mot courant mais d'autres relations pourront être aisement ajoutées par la suite car le diagramme de classe et l'infrastructure web ont été pensé ainsi.
